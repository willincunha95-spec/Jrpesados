...
function PortalDashboard() {
    ...
    const [historicoCount, setHistoricoCount] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(0);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const fetchData = async ()=>{
            try {
                ...
                // Perfil and Locacoes
                const resPerfil = await fetch(`${API_URL}/veiculos/meu-perfil`, {
                    headers
                });
                if (resPerfil.ok) {
                ...
                // Tracking
                const resRastreio = await fetch(`${API_URL}/veiculos/meus-rastreios`, {
                    headers
                });
                if (resRastreio.ok) {
                ...
                // Historico
                const resHist = await fetch(`${API_URL}/financeiro/meu-historico`, {
                    headers
                });
                if (resHist.ok) {
